  ...
  <?php include("navbar_top.php") ?>
    ...
    <section id="banner">
      <div class="inner">
        ...
        <p>
          Sign In Now to Make Attandance and receive Updates of your team.
          
        </p>
        <ul class="actions">
          <li><a href="login.php" class="button big special">Login In</a></li>
          <li>
            <a href="testing-dashboard.php" class="button big alt">Erm dummy button</a>
          </li>
        </ul>
      </div>
    </section>
        ...
        <div class="row">
          <div class="4u">
            <section class="special box">
              ...
              <h3>Apply Leave</h3>
              <p>
                Click here and use the new tools to apply for leave We will work
                toward better work environment.
              </p>
            </section>
          </div>
          <div class="4u">
            <section class="special box">
              ...
              <p>
                Eu non col commodo accumsan ante mi. Commodo consectetur sed mi
                adipiscing accumsan ac nunc tincidunt lobortis.
              </p>
            </section>
          </div>
          <div class="4u">
        ...
        <div class="row">
          ...
          <div class="4u">
            <section>
              ...
              <p>
                Feugiat amet accumsan ante aliquet feugiat accumsan. Ante
                ...
                ipsum dolor sit amet feugiat consequat.
              </p>
              <ul class="actions">
                <li><a href="#" class="button alt">Learn More</a></li>
              </ul>
